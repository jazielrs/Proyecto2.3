 ...
 * @author paovv
 */
public class FXMLShowProductController implements Initializable {
    ...
    @FXML
    private TableColumn<List<String>, String> cSupermarket;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.cSupermarket.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<List<String>, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<List<String>, String> data) {
        ...
        this.tableProduct.setItems(getData());
    }
    ...
    public ObservableList<List<String>> getData() {
        ...
        try {
            ...
            Logger.getLogger(FXMLShowProductController.class.getName()).log(Level.SEVERE, null, ex);
        }
